...
trn=load('C:\MATLAB6p5\work\raf\rbf\senza_beta\train.mat');
tst=load('C:\MATLAB6p5\work\raf\rbf\senza_beta\testsnzbeta.mat');
...
spread = 42.5;
display(spread);
net = NEWRB(P,Tcc,0.01,spread,6,15);  % addestramento
...
th = 0;
    ...
    for d = 1:1000    
        ...
        [sen(d), spe(d)] = risul_class(vet_soglia, Tss, 99);
    end
