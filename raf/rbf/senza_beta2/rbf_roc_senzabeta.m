...
trn=load('C:\MATLAB6p5\work\raf\senza_beta2\trainsenzab2.mat');
tst=load('C:\MATLAB6p5\work\raf\senza_beta\testsenzab2.mat');
...
spread = 42.5;
display(spread);
net = NEWRB(P,Tcc,0.01,spread,6,5);  % addestramento
