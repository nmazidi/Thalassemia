...
trn=load('C:\MATLAB6p5\work\raf\rbf\5_12\train.mat');
tst=load('C:\MATLAB6p5\work\raf\rbf\5_12\test.mat');
...
spread = 25;
display(spread);
net = NEWRB(P,Tcc,0.01,spread,14,5);  % addestramento
...
th = 0;
    ...
    for d = 1:1000    
        ...
        [sen(d), spe(d)] = risul_class(vet_soglia, Tss, 108);
    end
