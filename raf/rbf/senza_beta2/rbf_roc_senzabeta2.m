...
trn=load('C:\MATLAB6p5\work\raf\rbf\senza_beta2\trainsenzab2.mat');
tst=load('C:\MATLAB6p5\work\raf\rbf\senza_beta2\testsenzab2.mat');
...
spread = 40;
display(spread);
net = NEWRB(P,Tcc,0.01,spread,20,5);  % addestramento
    
a = sim(net,PP);                   
% calcolo risultati sul test
...
th = 0;
    ...
    for d = 1:1000    
        th = th + 0.01; 
        vet_soglia = soglia_rbf(a,99,th);
        [sen(d), spe(d)] = risul_class2(vet_soglia, Tss, 99);
    end
